...
class View:
    ...
    def start_quiz():
        # todo re-work methods, arguments etc. as needed 
    ...
    def ask_questions(self, questions, difficulty, points, topic_requested):
        ...
        for question, answer in questions.items():
            result = ask_one_question(question, answer)

        return results 


    def ask_one_question(question, answer):
        time_started = datetime.now()
        ...
        user_answer = view_util.get_user_answer()  # definitely new method
        user_answer = int(user_answer)-1  # can you avoid this? 
        ...
        # todo make a class for this. OneQuizQuestionResultForOneUser or a more concise name of your creation
